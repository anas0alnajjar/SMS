<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto" style="padding-right: 0;">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="?lang=en" class="dropdown-item lang-switcher" data-lang="en">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="?lang=ar" class="dropdown-item lang-switcher" data-lang="ar">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                ...
                @if (Auth::user()->user_type == 1)
                    <li class="nav-item"> <a href="{{ url('admin/dashboard') }}" class="nav-link @if(Request::segment(2)=='dashboard') active @endif"> <i
                            ...
                            <p>{{ __('messages.dashboard') }}
                            </p>
                        </a> </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/admin/list') }}" class="nav-link @if(Request::segment(2)=='admin') active @endif">
                            <i class="nav-icon bi bi-people"></i>
                            <p>{{ __('messages.admin_member') }}</p>
                        </a>
                    </li>
                    <li class="nav-item">
